...
xyi = create_async_engine(settings.DB_URL)  # echo=True для вывода в терминал запросов sqlalchemy в сыром виде
engine_null_pool = create_async_engine(settings.DB_URL, poolclass=NullPool)

async_session_maker = async_sessionmaker(bind=xyi, expire_on_commit=False)
